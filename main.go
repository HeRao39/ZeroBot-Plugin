...
func init() {
	...
	url := flag.String("u", "ws://127.0.0.1:8050", "Set Url of WSClient.")
	// 默认昵称
	adana := flag.String("n", "樱酱", "Set default nickname.")
	...
	config.Z = zero.Config{
		NickName:       append([]string{*adana}, "SAKURA", "sakura", "樱酱", "小樱"),
